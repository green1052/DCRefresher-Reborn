...
declare module '#imports' {
  ...
  export { getURL } from '../src/utils/getURL';
  export { default as http, urls, types, commentGallTypes, viewRegex, mgall, checkMinor, checkMini, checkPerson, galleryType, view, mergeParamURL, galleryTypeName, queryString } from '../src/utils/http';
  ...
  export { BLOCK_TYPES, MEMO_TYPES, blockStorage, blockModeStorage, memoStorage, modulesStorage, settingsStorage } from '../src/utils/storage';
  ...
  export { writeClipboard } from '../src/utils/writeClipboard';
}
