...
const EXTENSION_FONT_TARGETS =
    ".refresherFont .refresher-block-popup, .refresherFont .refresher-captcha-popup, .refresherFont .refresher-frame, .refresherFont .refresher-popup, .refresherFont .dcr-dialog, .refresherFont .dcr-bubble, .refresherFont .dcr-toast";
